...
;
statement
: labeled_statement {/*fprintf(flot_html,"-1");*/}
| compound_statement {/*fprintf(flot_html,"-2");*/}
| expression_statement {/*fprintf(flot_html,"-3");*/}
| selection_statement {/*fprintf(flot_html,"-4");*/}
| iteration_statement {/*fprintf(flot_html,"-5");*/}
| jump_statement
;
labeled_statement
